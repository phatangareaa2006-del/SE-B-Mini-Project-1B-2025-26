...
class _ActivityScreenState extends State<ActivityScreen> {
           ...
           double todayDistance = 0;
            ...
            for (var doc in docs) {
              if (doc.id == todayStr) {
                 ...
                 todaySteps = manualSteps + autoSteps;
               ...
               children: [
                 ...
                 Row(
                   children: [
                     ...
                     Expanded(child: _infoCard(Icons.route, "Distance", "${todayDistance.toStringAsFixed(1)} km", Colors.blueAccent)),
                   ]
                 ).animate().fadeIn(delay: 400.ms),
                 
                 const SizedBox(height: 40),
                 _buildWeeklyChart(docs),
  ...
  Widget _buildWeeklyChart(List<QueryDocumentSnapshot> rawDocs) {
